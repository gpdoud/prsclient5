...
export class RequestService {
  ...
  change(request: Request): Observable<any> {
    return this.http.post(`${this.baseurl}/update/${request.id}`, request) as Observable<any>;
  }
  remove(request: Request): Observable<Request> {
    return this.http.post(`${this.baseurl}/delete/${request.id}`, null) as Observable<Request>;
  }
  setReview(request: Request): Observable<any> {
    return this.http.post(`${this.baseurl}/review`, request) as Observable<any>;
  }
  setApproved(request: Request): Observable<any> {
    return this.http.post(`${this.baseurl}/approve`, request) as Observable<any>;
  }
  setRejected(request: Request): Observable<any> {
    return this.http.post(`${this.baseurl}/reject`, request) as Observable<any>;
  }
}
